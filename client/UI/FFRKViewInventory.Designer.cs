namespace FFRKInspector.UI
{
    partial class FFRKViewInventory
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dgcRES,
            this.dgcScore});
            this.dataGridViewEquipment.Location = new System.Drawing.Point(13, 66);
            ...
            this.dataGridViewEquipment.SortCompare += new System.Windows.Forms.DataGridViewSortCompareEventHandler(this.dataGridView1_SortCompare);
            // 
            // comboBoxUpgradeMode
            // 
    ...
    "pment\'s score on the right-hand pane";
            ...
            this.dgcCharacterOffensiveStat.Items.AddRange(new object[] {
            "ATK",
            "MAG",
            "MND"});
    ...
    "n weapons";
            ...
            this.dgcCharacterDefensiveStat.Items.AddRange(new object[] {
            "DEF",
            "RES"});
